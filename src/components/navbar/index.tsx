  ...
  render() {
    ...
    return <div className={classes.root}>
        <AppBar position="static" className={classes.navbar}>
          <Toolbar>
            <IconButton onClick={this.handleOpenDrawer} className={classes.menuButton} color="inherit" aria-label="Menu">
              <MenuIcon />
            </IconButton>
          ...
          <Drawer anchor="left" open={this.state.isDrawerOpened} onClick={this.handleCloseDrawer} onKeyDown={this.handleCloseDrawer}>
            {this.categoryList}
          </Drawer>
        </AppBar>
      </div>
